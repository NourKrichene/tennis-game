...
class GameScoreEvaluatorTest {
    ...
    void shouldReturnInvalidInput(String input) {
    ...
    void shouldReturnScoreOfUnfinishedGame(String input, String expected) {
        String result = computeGameScore(input);
    ...
    void shouldReturnScoreOfGameWithoutDeuce(String input, String expected) {
        String result = computeGameScore(input);
        assertEquals(expected, result);
    }
    ...
    void shouldReturnScoreOfGameWithDeuce(String input, String expected) {
        String result = computeGameScore(input);
        assertEquals(expected, result);
    }
}
